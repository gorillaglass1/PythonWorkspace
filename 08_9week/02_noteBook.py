...
if __name__ == '__main__':
    ...
    print(f"Second Page: {contents_book.notes[2]}")

    contents_book.remove_note(1)
    contents_book.add_note(Note('This is the new 1rd page'), 1)
    print(contents_book.get_number_of_pages())
    print("list:", list(contents_book.notes.keys()))

    contents_book.add_note(Note('This is the 7nd page'), 7)
